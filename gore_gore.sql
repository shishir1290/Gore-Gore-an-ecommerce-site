...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2023 at 12:51 AM
...
INSERT INTO `orderinfo` (`orderId`, `customerName`, `product_id`, `productPrice`, `payment_method`) VALUES
(35, 'whiteface', 10, 250, 'bkash');
...
CREATE TABLE `product` (
  ...
  `productReview` varchar(2000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `product` (`productId`, `productName`, `price`, `pic`, `productDetails`, `productReview`) VALUES
...
(26, 'Cycle brooch Hijab Safety Pin', 120, 'picture/brooch.jpg', 'Origin: CN(Origin)\r\nMetals Type: cristal\r\nShape\\pattern: Geometric\r\nBrooches Type: Brooches\r\nStyle: Vintage', ''),
(27, 'Wireless Microphone Professional', 799, 'picture/microphone.jpg', '9 ms ultra-low latency,20 m barrier-free receptionIt doesn\'t need APP, plug-and-play,one-click connection, easy to wear.Intelligent noise reduction,long-endurance of 10 hours360 full pointing pick up, record every detail of the sound.Small and convenient, it compatible with various devicesSmall and convenient, it is compatible with various devices, supports mobile phones, tablets, cameras, notebooks, etcFrequency: 2.4GHzInput voltage: DC4.8-5.4VCharging port: Type-CBattery capacity: 80mAhTransmission Distance: up to 10 metersMicrophone size: 62*23 * 28mmMicrophone weight: 7gReceiver size: 45*27 * 7mmReceiver weight: 4g', '');
...
INSERT INTO `userinfo` (`userId`, `username`, `password`, `firstname`, `lastname`, `gender`, `dob`, `email`, `phone`, `address`, `userPic`) VALUES
(7, 'shishir', '123', 'Sadmanur', 'Shishir', 'male', '2023-04-11 18:02:11', 'shishir1290@gmail.com', 8801946435234, 'Konabari, Gazipur', 'img-2023.04.11-08.02.11pm.png'),
(16, 'sinthia', '123', 'Sinthia', 'Jahan', 'female', '2023-04-05 19:50:23', 'sinthiajahan12801@gmail.com', 8801946432532, 'Konabari\r\nGazipur', 'img-2023.04.05-09.50.23pm.jpg'),
(29, 'first', '123', 'first', 'first', 'male', '2023-04-04 18:00:00', 'first@gmail.com', 12015, 'dfea', '');
...
--
ALTER TABLE `userinfo`
  MODIFY `userId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
COMMIT;
